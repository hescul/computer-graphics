...
std::vector<float> Cube::vertices() const {
	...
	std::cout << std::format("BaseCenter({}, {}, {})\n", baseCenter.x, baseCenter.y, baseCenter.z);
	std::cout << "Base Radius: " << baseRadius << '\n';
	...
	std::cout << std::format("p0({}, {}, {})\n", p0.x, p0.y, p0.z);
	std::cout << std::format("p1({}, {}, {})\n", p1.x, p1.y, p1.z);
	std::cout << std::format("p2({}, {}, {})\n", p2.x, p2.y, p2.z);
	std::cout << std::format("p3({}, {}, {})\n", p3.x, p3.y, p3.z);
	std::cout << std::format("p4({}, {}, {})\n", p4.x, p4.y, p4.z);
	std::cout << std::format("p5({}, {}, {})\n", p5.x, p5.y, p5.z);
	std::cout << std::format("p6({}, {}, {})\n", p6.x, p6.y, p6.z);
	std::cout << std::format("p7({}, {}, {})\n", p7.x, p7.y, p7.z);
